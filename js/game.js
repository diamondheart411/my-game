    ...
    play(){
        ...
        this.b0.mousePressed(()=>{
          ...
          bClicked.play();
           ...
           this.btans01=createButton("50 states,7 territories")
           this.btans01.style('backgroundColor','red');
           this.btans02=createButton("100 states,50 territories")
           this.btans03=createButton("100 states,8 territories")
           this.btans04=createButton("50 states, 14 territories")
           this.btans01.position(displayWidth/2 - 230, displayHeight/2-195)
           this.btans02.position(displayWidth/2 - 30, displayHeight/2-195)
           this.btans02.style('backgroundColor','green');
           this.btans03.position(displayWidth/2 - 230, displayHeight/2-95)
           this.btans03.style('backgroundColor','pink');
           this.btans04.position(displayWidth/2 - 30, displayHeight/2-95)
           this.btans04.style('backgroundColor','lightblue');
            this.greetingQ0.html("There are __________________states and ___________________ territories")
          ...
          // alert(this.btans04.elt.innerHTML);
            ...
            this.btans04.mousePressed(()=>{
                ...
                this.greeting2.html("DID YOU KNOW: None of the citezens who live in any of the US territories can vote! ");
        ...
        this.b1.mousePressed(()=>{
           ...
           this.btans11=createButton("Utah")
           this.btans11.style('backgroundColor','red');
           this.btans12=createButton("Minnesota")
           this.btans13=createButton("Texas")
           this.btans14=createButton("Hydrabad")
           this.btans11.position(displayWidth/2 - 230, displayHeight/2-195)
           this.btans12.position(displayWidth/2 - 30, displayHeight/2-195)
           this.btans12.style('backgroundColor','green');
           this.btans13.position(displayWidth/2 - 230, displayHeight/2-95)
           this.btans13.style('backgroundColor','pink');
           this.btans14.position(displayWidth/2 - 30, displayHeight/2-95)
           this.btans14.style('backgroundColor','lightblue');
            this.greetingQ1.html("In which State is the Mall of America located ")
            ...
            this.btans12.mousePressed(()=>{
                ...
                this.greeting2=createElement("h2");
                this.greeting.html("Yes, You Are Right");
                this.greeting2.html(" DID YOU KNOW: The Mall of America is the largest mall in the USA ");
                this.greeting.position(displayWidth/2-150,displayHeight/2-150)
                this.greeting2.position(displayWidth/2-400,displayHeight/2-50)
                //this.b0.attribute('disabled','disabled')
                correctAns.play();
        ...
        this.b2.mousePressed(()=>{
           ...
           this.btans21=createButton("November 14, 2008")
           this.btans22=createButton("June 29, 2010")
           this.btans23=createButton("June 29, 2007")
           this.btans24=createButton("November 14, 2007")
           this.btans21.position(displayWidth/2 - 230, displayHeight/2-195)
           this.btans21.style('backgroundColor','red');
           this.btans22.position(displayWidth/2 - 30, displayHeight/2-195)
           this.btans22.style('backgroundColor','green');
           this.btans23.position(displayWidth/2 - 230, displayHeight/2-95)
           this.btans23.style('backgroundColor','pink');
           this.btans24.position(displayWidth/2 - 30, displayHeight/2-95)
           this.btans24.style('backgroundColor','lightblue');
            this.greetingQ2.html("When  was the first Iphone released")
           ...
           console.log(ask);
            ...
            this.btans23.mousePressed(()=>{
                ...
                this.greeting2=createElement("h2");
                this.greeting.html("Yes, You Are Right");
                this.greeting2.html("DID YOU KNOW: Steve Jobs was fired as CEO from the company he founded");
                this.greeting.position(displayWidth/2-150,displayHeight/2-150)
                this.greeting2.position(displayWidth/2-400,displayHeight/2-50)
                //this.b0.attribute('disabled','disabled')
                correctAns.play();
        ...
        this.b3=createButton("Harry Potter");
        ...
        this.b3.mousePressed(()=>{
          ask+=1
            ...
            this.btans31=createButton("2007")
            this.btans32=createButton("1997")
            this.btans33=createButton("1998")
            this.btans34=createButton("1999")
            this.btans31.position(displayWidth/2 - 230, displayHeight/2-195)
            this.btans31.style('backgroundColor','red');
            this.btans32.position(displayWidth/2 - 30, displayHeight/2-195)
            this.btans32.style('backgroundColor','green');
            this.btans33.position(displayWidth/2 - 230, displayHeight/2-95)
            this.btans33.style('backgroundColor','pink');
            this.btans34.position(displayWidth/2 - 30, displayHeight/2-95)
            this.btans34.style('backgroundColor','lightblue');
             this.greetingQ3.html("When did Harry Potter and the Sorcerer's stone novel come out")
             ...
             this.btans32.mousePressed(()=>{
                 ...
                 this.greeting2=createElement("h2");
                 this.greeting.html("Yes, You Are Right");
                 this.greeting2.html("DID YOU KNOW: Harry Potter is a Slytherin but asked the hat to place him in Gryffindor");
                 this.greeting.position(displayWidth/2-150,displayHeight/2-150)
                 this.greeting2.position(displayWidth/2-400,displayHeight/2-50)
                 //this.b0.attribute('disabled','disabled')
                 correctAns.play();
        ...
        this.b4=createButton("Hollywood");
        ...
        this.b4.mousePressed(()=>{
            ...
            this.btans41=createButton("Hollywood")
            this.btans42=createButton("Sainthollywood")
            this.btans43=createButton("Hollywoodland")
            this.btans44=createButton("Holly Macaroni")
            this.btans41.position(displayWidth/2 - 230, displayHeight/2-195)
            this.btans41.style('backgroundColor','red');
            this.btans42.position(displayWidth/2 - 30, displayHeight/2-195)
            this.btans42.style('backgroundColor','green');
            ...
            this.btans44.style('backgroundColor','lightblue');
             this.greetingQ4.html("What did the sign originally say?")
             ...
             this.btans43.mousePressed(()=>{
                 ...
                 this.greeting2=createElement("h2");
                 this.greeting.html("Yes, You Are Right");
                 this.greeting2.html("DID YOU KNOW: The L, A, N, & D fell off");
                 this.greeting.position(displayWidth/2-150,displayHeight/2-150)
                 this.greeting2.position(displayWidth/2-400,displayHeight/2-50)
                 //this.b0.attribute('disabled','disabled')
                 correctAns.play();
        ...
        this.b5.mousePressed(()=>{
            ...
            this.btans51=createButton("Neelkantha Bhanu Prakash")
            this.btans52=createButton("Mark Mather")
            ...
            this.btans54.style('backgroundColor','lightblue');
             ...
             this.btans51.mousePressed(()=>{
                 ...
                 this.greeting2=createElement("h2");
                 this.greeting.html("Yes, You Are Right");
                 this.greeting2.html("DID YOU KNOW:The 21-year-old won India's first gold medal in the Mental Calculation World Championship");
                 this.greeting.position(displayWidth/2-150,displayHeight/2-150)
                 this.greeting2.position(displayWidth/2-400,displayHeight/2-50)
                 //this.b0.attribute('disabled','disabled')
                 correctAns.play();
